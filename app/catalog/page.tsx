...
const ProductCategoriesGrid = () => {
  const categories = [
    ...
    { id: "10", title: "Reflectors and Glass", image: "/images/product6.png" },
  ];
...
"
    ...
    <div className="absolute inset-0 flex flex-col justify-between p-6 z-10">
      <h3 className={`text-md xl:text-xl font-bold text-red-700`}>
        {category.title}
      </h3>

      <div
        className={`self-end w-10 h-10 flex items-center justify-center  transition-all  text-red-500 group-hover:bg-white/80`}
      >
