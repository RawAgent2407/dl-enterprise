    ...
    <>
      <div className="space-y-6 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pb-6 border-b border-gray-300">
          <button
            className="bg-black text-white py-3 px-6 font-semibold  hover:bg-gray-800 transition-colors"
            onClick={() => {
          ...
          <button
            className="bg-red-600 text-white py-3 px-6 font-semibold  hover:bg-red-700 transition-colors flex items-center justify-center"
