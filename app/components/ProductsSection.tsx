...
export default function ProductsSection() {
  ...
  const products: Product[] = [
    { id: "1", title: "LED Tube Lights", image: "/images/product0.png" },
    { id: "2", title: "COB Lights", image: "/images/product1.png" },
    { id: "3", title: "Flood / Street Lights", image: "/images/product2.png" },
    { id: "4", title: "Hanging Lights", image: "/images/product3.png" },
    { id: "5", title: "LED Plastic Panels", image: "/images/product4.png" },
    {
      id: "6",
      title: "LED Driver & Controllers",
      image: "/images/product5.png",
    },
    { id: "7", title: "Reflectors and Glass", image: "/images/product6.png" },
  ];
  const getCardWidth = () => {
  ...
  return (
    <div className="w-full bg-white py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-12 xl:px-20">
      <div className="w-full max-w-[1920px] mx-auto">
        {/* ================= HEADER ================= */}
        <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8 mb-5 sm:mb-7 lg:mb-10">
...
"
                ...
                {/* Arrow */}
                <div className="absolute bottom-8 right-8 text-red-600 transition-transform duration-300 group-hover:translate-x-1">
