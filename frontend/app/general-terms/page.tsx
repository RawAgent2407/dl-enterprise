        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12'>
          ...
          <div>
            ...
            <p className='text-gray-700 mb-4'>
              DL Enterprise manufactures and supplies LED lighting solutions
          ...
          <div>
            ...
            <p className='text-gray-700'>
              ...
              net 30 days from invoice date unless otherwise agreed upon in
              writing. Late payments may incur additional charges as permitted
              by law.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-gray-700'>
              All orders are subject to acceptance by DL Enterprise. We reserve
              the right to refuse or cancel any order for any reason, including
              but not limited to product availability, errors in product or
              pricing information, or problems identified by our credit or fraud
              departments.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-gray-700'>
              Delivery dates are estimates only and are not guaranteed. DL
              Enterprise will not be liable for any delays in delivery. Risk of
              loss and title for products pass to the customer upon delivery to
              the carrier.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-gray-700'>
              Products may be returned within 30 days of delivery, subject to
              our return policy. Items must be in original condition and
              packaging. Custom or specially ordered items are not returnable
              unless defective.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-gray-700'>
              ...
              graphics, logos, images, and software, is the property of DL
              Enterprise and is protected by copyright and other intellectual
              property laws.
            </p>
          </div>
          ...
          <div>
            ...
            <p className='text-gray-700'>
              DL Enterprise's liability for any claim arising from the use of
              our products or services shall not exceed the purchase price of
